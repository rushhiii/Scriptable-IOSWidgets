...
### 4️ Setup the Widget in Scriptable

1. **Download** [Scriptable](https://apps.apple.com/in/app/scriptable/id1405459188) app from App Store.
2. **Download** the [CountdownWidget.js](./Countdown.js) script.
...
6. Configure the widget through parameter values as needed [(see below)](#️-configure). 

## ⚙️ Widget Configure/Usage
...
age
```
* **Select by index (Small Widget):**
```
2
```
* **Select by name and show age (Small Widget):**
```
john,age
```
* **Enable Grid View (Medium & large Widgets):**
```
col
```
<br/>
